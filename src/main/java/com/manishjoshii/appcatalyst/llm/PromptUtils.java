package com.manishjoshii.appcatalyst.llm;
...
public class PromptUtils {
    ...
    public final static String CODE_GENERATION_SYSTEM_PROMPT = """
            ...
            **Semantic Colors Only - Never Use Direct Colors**
            - ✅ CORRECT: tn-primary, g-base-100, 	ext-base-content
            - ❌ WRONG: g-white, 	ext-black, g-blue-500

            **Visual Hierarchy**
            - Hero headings: 	ext-5xl font-bold
            - Section titles: 	ext-3xl font-semibold
            - Subsections: 	ext-2xl font-semibold
            - Body: 	ext-base leading-relaxed
            - Muted: 	ext-base-content/70
        ...
        Button
            ...
            **Code Quality**:
            ...
            6. **Semantic classes only** - Never use g-white, 	ext-black, etc.
